            ...
            <table class="table table-dark">
              ...
              @foreach($tasks as $task)
                ...
                <button class="btn btn-warning">Not Completed</button>
                 ...
                 <td>
                 @if(!$task->iscompleted)
                   <a href="/markascompleted/{{$task->id}}" class="btn btn-primary">Make As Completed</a>
                 @else
                   <a href="/markasnotcompleted/{{$task->id}}" class="btn btn-danger">Make As Not Completed</a>
                 @endif
